...
public class ListVideoUtil {
    ...
    private UTStandardGSYVideoPlayer gsyVideoPlayer;
    ...
    private UTStandardVideoAllCallBack videoAllCallBack;
    private String url;
    ...
    public ListVideoUtil(Context context) {
        gsyVideoPlayer = new UTStandardGSYVideoPlayer(context);
     ...
     */
    private void resolveMaterialFullVideoShow(UTBaseVideoPlayer gsyVideoPlayer) {
     ...
     * 动画回到正常效果
     */
    private void resolveMaterialToNormal(final UTVideoPlayer gsyVideoPlayer) {
    ...
    public void showSmallVideo(Point size, final boolean actionBar, final boolean statusBar) {
        if (gsyVideoPlayer.getCurrentState() == UTVideoPlayer.CURRENT_STATE_PLAYING) {
     ...
     */
    public void setVideoAllCallBack(UTStandardVideoAllCallBack videoAllCallBack) {
     ...
     */
    public UTStandardGSYVideoPlayer getGsyVideoPlayer() {
